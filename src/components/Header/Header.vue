        ...
        <div class="container">
          <router-link to="/">
            <div class="header__logo">
              <img width="100" :src="alatooLogo" alt="Alatoo logo" />
          ...
          <div class="header__serch-bar">
            <div class="search-bar__input">
              <input @input="handleInput" v-model="seacrhData" type="text" placeholder="Enter text to search...">
          ...
          <div class="header__cart">
            <router-link to="/cart" class="button button--cart">
              <span>{{totalSum ? totalSum : 0}} с</span>
...
<script>
import alatooLogo from "@/assets/img/alatooLogo.svg"
...
export default {
    setup() {
      ...
      return{alatooLogo,totalSum,totalCount,seacrhIcon,seacrhIconBlack,seacrhData,handleInput}
    }
}
</script>
