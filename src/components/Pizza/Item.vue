<template>
  <div v-if="pizza" class="pizza-block">
    <div class="pizza-block__image">
      <img :src="pizza.imageUrl" alt="Pizza" />
    </div>
    <div class="pizza-block__subtitle">{{ pizza.manufacturer }}</div>
    <div class="pizza-block__title">{{ pizza.name }}</div>
    <div class="pizza-block__bottom">
      <div class="pizza-block__price">
        {{ pizza.price[selectedPizzaPrice] }} c
      </div>
