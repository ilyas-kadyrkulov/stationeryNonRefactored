    ...
    <form>
      <div class="inputs">
        <div>
          ...
          <input type="text" placeholder="asssaaasasdas" />
        </div>
        <div>
      ...
      <div class="selectors">
        <div class="selectors-up">
          <div class="select__sizes">
            ...
            <div class="sizes">
              <div v-for="item in sizeItems" :key="item" class="size">
                <Checkbox
                  @selectedValue="handleSizesCheckboxes"
                  :value="item"
                  :labelValue="`${item} см`"
                />
              </div>
          ...
          <div class="select__types">
            ...
            <div class="types">
              <Checkbox
                @selectedValue="handleTypesCheckboxes"
...
export default {
  ...
  setup() {
    ...
    const handleSizesCheckboxes = (value) => {
    ...
    return {
      ...
      pizzaCategory,
      pizzaRating,
      handleSizesCheckboxes,
      handleTypesCheckboxes,
    };
  },
};
</script>
